...
#define TAG "YcscEmojiDisplay"

// 表情映射表 - 将多种表情映射到现有6个GIF
const YcscEmojiDisplay::EmotionMap YcscEmojiDisplay::emotion_maps_[] = {
    // 中性/平静类表情 -> miaomiao
    {"neutral", &miaomiao},
    {"relaxed", &miaomiao},
    {"sleepy", &miaomiao},
...
YcscEmojiDisplay::YcscEmojiDisplay(esp_lcd_panel_io_handle_t panel_io,
...
void YcscEmojiDisplay::SetupGifContainer() {
...
void YcscEmojiDisplay::SetEmotion(const char* emotion) {
...
void YcscEmojiDisplay::SetChatMessage(const char* role, const char* content) {
    DisplayLockGuard lock(this);
